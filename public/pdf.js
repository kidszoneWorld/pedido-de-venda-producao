document.addEventListener("DOMContentLoaded", () => {
    ...
    btPdfGeneration.addEventListener("click", async () => {
        ...
        // Oculta os elementos que não devem aparecer no PDF
        ...
        // Oculta o helpContainer antes de gerar o PDF
        helpWhats.style.display = 'none';// Oculta o helpContainer antes de gerar o PDF
        ...
        try {
            ...
            closeButton1.addEventListener("click", () => {
                ...
                helpWhats.style.display = 'block'; // Reexibe o helpContainer
            });
